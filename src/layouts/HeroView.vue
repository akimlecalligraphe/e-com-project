      ...
      <div class="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
        ...
        <div>
          <div class="mt-10">
            ...
            <div aria-hidden="true" class="pointer-events-none lg:inset-y-0 lg:mx-auto lg:w-full lg:max-w-7xl">
              <div
                class="mt-50 absolute transform sm:top-0 sm:left-1/2 sm:translate-x-8 lg:top-1/2 lg:left-1/2 lg:translate-x-8 lg:-translate-y-1/2">
